...
namespace labAPI.Migrations
{
    public partial class DataBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Plant",
                columns: new[] { "PlantId", "Name", "Position" },
                values: new object[,]
                {
                    { new Guid("88acbca8-684d-4b20-b5de-024705497d4a"), "Derevo", "Zemlia" },
                    { new Guid("86dba8c0-d158-41f7-938c-ed49778cb52a"), "Flower", "Trava" },
                    { new Guid("021ca3c1-0deb-4bbd-ae94-2159a9679811"), "Kaktus", "Pesok" }
                });
